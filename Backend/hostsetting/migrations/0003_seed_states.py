# Generated by Django 5.1.1 on 2024-10-21 22:40

from django.db import migrations

def seed_states(apps, schema_editor):
    States = apps.get_model('hostsetting', 'States')
    states_data = [
    ...
    for state in states_data:
        States.objects.get_or_create(state_code=state['state_code'], state_name=state['state_name'])

class Migration(migrations.Migration):

    dependencies = [
        ('hostsetting', '0002_eventdetails_creator_email_eventdetails_event_image_and_more'),
    ]

    operations = [
        migrations.RunPython(seed_states),
    ]
